...
import { COMPANY_LOCATION } from '../constants/company';
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 8, marginBottom: 14 }}>
        ...
        <button className="btn btn-outline btn-sm" onClick={async () => {
          ...
          const result = await generateMemoPDF({
            companyLocation: COMPANY_LOCATION, firmName: fresh.challan.firmName, challanNumber: fresh.challan.challanNumber,
      ...
      <div className="memo-doc-wrap">
        <MemoPrint ref={printRef} challan={challan} companyLocation={COMPANY_LOCATION} rows={rows} />
      </div>
